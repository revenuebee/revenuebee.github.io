...
mermaid: true
image:
  path: /assets/img/posts/文本和排版-1.png
...
![图片描述](/assets/img/posts/文本和排版-2.png){: width="972" height="589" }
_全屏宽度并居中对齐_

### 左对齐

![图片描述](/assets/img/posts/文本和排版-2.png){: width="972" height="589" .w-75 .normal}

### 向左浮动

![图片描述](/assets/img/posts/文本和排版-2.png){: width="972" height="589" .w-50 .left}
...
![图片描述](/assets/img/posts/文本和排版-2.png){: width="972" height="589" .w-50 .right}
...
![仅限浅色模式](/assets/img/posts/文本和排版-3.png){: .light .w-75 .shadow .rounded-10 w='1212' h='668' }
![仅限深色模式](/assets/img/posts/文本和排版-4.png){: .dark .w-75 .shadow .rounded-10 w='1212' h='668' }
